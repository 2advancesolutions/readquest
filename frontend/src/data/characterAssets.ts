...
export const EFFECT_OVERLAYS: Record<string, { gradient: string; emoji: string[] }> = {
  fire_aura:    { gradient: 'radial-gradient(ellipse at bottom, rgba(239,68,68,0.35) 0%, transparent 65%)', emoji: ['🔥','🔥'] },
  ice_crystals: { gradient: 'radial-gradient(ellipse at bottom, rgba(147,197,253,0.35) 0%, transparent 65%)', emoji: ['❄️','❄️'] },
  star_trail:   { gradient: 'radial-gradient(ellipse at center, rgba(251,191,36,0.2) 0%, transparent 70%)',  emoji: ['⭐','✨'] },
  lightning:    { gradient: 'radial-gradient(ellipse at top, rgba(250,204,21,0.3) 0%, transparent 65%)',     emoji: ['⚡','⚡'] },
  rainbow_glow: { gradient: 'radial-gradient(ellipse at center, rgba(167,139,250,0.25) 0%, transparent 70%)', emoji: ['🌈'] },
  sparkles:     { gradient: 'radial-gradient(ellipse at center, rgba(192,132,252,0.2) 0%, transparent 70%)', emoji: ['✨','✨','✨'] },
  flower_bloom: { gradient: 'radial-gradient(ellipse at center, rgba(236,72,153,0.2) 0%, transparent 70%)', emoji: ['🌸','🌸'] },
  galaxy_swirl: { gradient: 'radial-gradient(ellipse at center, rgba(109,40,217,0.4) 0%, transparent 65%)', emoji: ['🌌','⭐'] },
}
