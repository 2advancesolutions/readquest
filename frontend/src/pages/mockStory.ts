...
export const MOCK_STORY: Story = {
  ...
  pages: [
    { id: 'p1', story_id: 'mock-1', page_number: 1, word_count: 45, content: p1, media_url: '/page1.png' },
    { id: 'p2', story_id: 'mock-1', page_number: 2, word_count: 50, content: p2, media_url: '/page2.png' },
    { id: 'p3', story_id: 'mock-1', page_number: 3, word_count: 55, content: p3, media_url: '/page3.png' },
    { id: 'p4', story_id: 'mock-1', page_number: 4, word_count: 48, content: p4, media_url: '/page4.png' },
    { id: 'p5', story_id: 'mock-1', page_number: 5, word_count: 42, content: p5, media_url: '/page5.png' },
  ],
  quiz_questions: [
